...
container.innerHTML = `
<h1 id="title" class="text-center">Countries & Weather  details<br>Using fetch api</h1><br/><br/>
<div class="row" id="content">
    <div class="text-center">
        <img class="loader" src="https://th.bing.com/th/id/OIG1.SIZF79TxbZfxil6tVOa.?pid=ImgGn">
    </div>
</div>
`;
...
async function buttonClick(lat, long, weatherTextId, btnID) {
    try {
        ...
        const APIURL = "https://api.openweathermap.org/data/2.5/weather?lat=" + lat + "&lon="+ long +"&appid=5a53d12080d4719435f1117a7ef765e3";
...
async function refreshWeather(refreshLat, refreshLong, weatherTextId) {
    try {
        const refreshURL = "https://api.openweathermap.org/data/2.5/weather?lat=" + refreshLat + "&lon="+ refreshLong +"&appid=5a53d12080d4719435f1117a7ef765e3";
